...
const slider = () => {
  ...
  btn1.classList.add("car-active");
  btn2.classList.remove("car-active");
  btn3.classList.remove("car-active");
  btn4.classList.remove("car-active");
};
btn1.addEventListener("click", slider);
// btn1.onclick = sliderImage(0);
btn2.onclick = function () {
  slide.style.transform = "translateX(-100%)";
  btn1.classList.remove("car-active");
  btn2.classList.add("car-active");
  btn3.classList.remove("car-active");
  btn4.classList.remove("car-active");
};
